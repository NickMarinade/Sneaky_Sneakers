  ...
  return (
    <div className="card">
      ...
      <div className="favorite" onClick={onClickFavorite}>
        {onFavorite && <img
          src={isFavorite ? "verou-4-react-advanced-NickMarinade/img/liked.svg" : "verou-4-react-advanced-NickMarinade/img/unliked.svg"}
          alt="Favorite"
        />}
      </div>
      ...
      <div className="cardBottom">
        ...
        {onPlus && <img
          className="plus"
          onClick={onClickPlus}
          src={isItemAdded(id) ? "verou-4-react-advanced-NickMarinade/img/btn-checked.svg" : "verou-4-react-advanced-NickMarinade/img/btn-plus.svg"}
          alt="Add_To_Cart"
        />}
      </div>
      </>
